...
public class strilba_efect_cs : MonoBehaviour
{
    ...
    void Start()
    {
        ff = new Vector3();
        time = 0;
        float d = VoidSystem_cs.Dist(prytc.transform.position, transform.position);// Mathf.Sqrt((prytc.transform.position.x - transform.position.x) * (prytc.transform.position.x - transform.position.x) + (prytc.transform.position.y - transform.position.y) * (prytc.transform.position.y - transform.position.y) + (prytc.transform.position.z - transform.position.z) * (prytc.transform.position.z - transform.position.z));
